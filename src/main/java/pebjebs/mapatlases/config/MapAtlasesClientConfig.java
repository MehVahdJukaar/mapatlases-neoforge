package pebjebs.mapatlases.config;

import net.minecraftforge.common.ForgeConfigSpec;
import pebjebs.mapatlases.client.ActivationLocation;
import pebjebs.mapatlases.client.Anchoring;
...
public class MapAtlasesClientConfig {
    ...
    static {
        ...
        activationLocation = builder
                .comment("Controls location where mini-map displays.")
                .defineEnum("activationLocation", ActivationLocation.HOTBAR);
