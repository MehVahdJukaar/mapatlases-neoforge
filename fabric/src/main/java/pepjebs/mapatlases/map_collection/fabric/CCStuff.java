...
public final class CCStuff implements ItemComponentInitializer {
    ...
    public void registerItemComponentFactories(ItemComponentFactoryRegistry registry) {
        registry.register(MapAtlasesMod.MAP_ATLAS.get(), MAP_COLLECTION_COMPONENT, i-> new IMapCollectionImpl());
    }
